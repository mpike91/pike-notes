...
const themes: { value: Theme; label: string; description: string }[] = [
  ...
  { value: 'dark-gray', label: 'Dark (Gray)', description: 'True dark mode' },
  { value: 'dark-slate', label: 'Dark (Slate)', description: 'Cool blue-gray' },
];

export default function SettingsPage() {
  const router = useRouter();
  const { theme, setTheme } = useUIStore();
  const { tabSize, fontSize, setTabSize, setFontSize } = useSettingsStore();
      ...
      <div className="flex-1 overflow-y-auto p-4 md:p-6">
        <div className="max-w-lg mx-auto space-y-8">
          ...
          <section>
            ...
            <p className="text-sm text-text-secondary">Pike Notes — a Pike app</p>
