...
export function SearchModal({ open, onClose }: SearchModalProps) {
  ...
  const commands: SearchResult[] = [
    ...
    { type: 'command', command: { label: 'Theme: Gray', action: () => { setTheme('dark-gray' as Theme); onClose(); } } },
    { type: 'command', command: { label: 'Theme: Coffee', action: () => { setTheme('dark-coffee' as Theme); onClose(); } } },
    { type: 'command', command: { label: 'Theme: Slate', action: () => { setTheme('dark-slate' as Theme); onClose(); } } },
    { type: 'command', command: { label: 'Theme: Wine', action: () => { setTheme('dark-wine' as Theme); onClose(); } } },
    { type: 'command', command: { label: 'Theme: Moss', action: () => { setTheme('dark-moss' as Theme); onClose(); } } },
