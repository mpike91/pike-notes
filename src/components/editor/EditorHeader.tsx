...
export function EditorHeader({
  ...
  return (
    <div className="relative z-50 flex items-center gap-2 border-b border-border bg-toolbar-bg px-4 py-3 md:py-2.5 md:px-6">
      <button
        onClick={onBack}
        tabIndex={-1}
      ...
      {onOutdent && (
        <button
          onClick={onOutdent}
          tabIndex={-1}
          className="md:hidden rounded-md p-2 text-text-muted hover:text-text-secondary hover:bg-bg-tertiary transition-colors"
          aria-label="Outdent"
          title="Outdent"
        >
      ...
      {/* Quick actions — desktop only (mobile uses dropdown) */}
      {!note.is_trashed && (
        <>
          <button
            onClick={onArchive}
            tabIndex={-1}
            className="hidden md:inline-flex rounded-md p-2 md:p-1.5 text-text-muted hover:text-text-secondary hover:bg-bg-tertiary transition-colors"
          ...
          <button
            onClick={onTrash}
            tabIndex={-1}
            className="hidden md:inline-flex rounded-md p-2 md:p-1.5 text-text-muted hover:text-danger hover:bg-danger/5 transition-colors"
      ...
      {/* Split view toggle — hidden for now */}
      {false && (
        <button
